...
const paragraphs: string[] = [
  ...
  "While the project utilized a full stack, I primarily worked on the backend as a web-scraper using Beautiful Soup, finding news articles which my teammates would supplement with their findings to display to the user. I also worked on some frontend styling",
